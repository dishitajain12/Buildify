...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Buildify',
  SIGNIN_SUBHEADING: 'To use Buildify you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Buildify, you agree to the collection of usage data for analytics.',
